...
const items = [
  ...
  {
    id: 3,
    question: 'Вы работаете только с премиум-сегментом?',
    answer: 'Нет, мы выполняем ремонты от простого до премиального класса. Наша цель — воплотить ваши идеи в жизнь, независимо от бюджета. Мы подбираем оптимальные решения и материалы, чтобы результат превзошел ваши ожидания, оставаясь в рамках запланированных расходов.',
  },
  {
    id: 4,
