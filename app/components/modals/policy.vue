    ...
    >
      ...
      <div class="modal__text">
        <section class="modal__section" aria-labelledby="policy-s1">
          ...
          <p><strong>1.2.</strong> Настоящая политика Оператора в&nbsp;отношении обработки персональных данных (далее&nbsp;— Политика) применяется ко&nbsp;всей информации, которую Оператор может получить о&nbsp;посетителях веб-сайта&nbsp;<a href="https://bulgakov.ru" class="modal__link" rel="noopener noreferrer" target="_blank">https://bulgakov.ru</a>.</p>
        </section>
        ...
        <section class="modal__section" aria-labelledby="policy-s2">
          ...
          <p><strong>2.3.</strong> Веб-сайт&nbsp;— совокупность графических и&nbsp;информационных материалов, а&nbsp;также программ для ЭВМ и&nbsp;баз данных, обеспечивающих их&nbsp;доступность в&nbsp;сети интернет по&nbsp;сетевому адресу&nbsp;<a href="https://bulgakov.ru" class="modal__link" rel="noopener noreferrer" target="_blank">https://bulgakov.ru</a>.</p>
          ...
          <p><strong>2.8.</strong> Персональные данные&nbsp;— любая информация, относящаяся прямо или косвенно к&nbsp;определенному или определяемому Пользователю веб-сайта&nbsp;<a href="https://bulgakov.ru" class="modal__link" rel="noopener noreferrer" target="_blank">https://bulgakov.ru</a>.</p>
          ...
          <p><strong>2.10.</strong> Пользователь&nbsp;— любой посетитель веб-сайта&nbsp;<a href="https://bulgakov.ru" class="modal__link" rel="noopener noreferrer" target="_blank">https://bulgakov.ru</a>.</p>
        ...
        <section class="modal__section" aria-labelledby="policy-s8">
          ...
          <p><strong>8.3.</strong> В&nbsp;случае выявления неточностей в&nbsp;персональных данных, Пользователь может актуализировать их&nbsp;самостоятельно, путем направления Оператору уведомление на&nbsp;адрес электронной почты Оператора&nbsp;<a href="mailto:info@bulgakov.ru" class="modal__link">info@bulgakov.ru</a>&nbsp;с&nbsp;пометкой «Актуализация персональных данных».</p>
          ...
          <p>Пользователь может в&nbsp;любой момент отозвать свое согласие на&nbsp;обработку персональных данных, направив Оператору уведомление посредством электронной почты на&nbsp;электронный адрес Оператора&nbsp;<a href="mailto:info@bulgakov.ru" class="modal__link">info@bulgakov.ru</a>&nbsp;с&nbsp;пометкой «Отзыв согласия на&nbsp;обработку персональных данных».</p>
        ...
        <section class="modal__section" aria-labelledby="policy-s12">
          ...
          <p><strong>12.1.</strong> Пользователь может получить любые разъяснения по&nbsp;интересующим вопросам, касающимся обработки его персональных данных, обратившись к&nbsp;Оператору с&nbsp;помощью электронной почты&nbsp;<a href="mailto:info@bulgakov.ru" class="modal__link">info@bulgakov.ru</a>.</p>
          ...
          <p><strong>12.3.</strong> Актуальная версия Политики в&nbsp;свободном доступе расположена в&nbsp;сети Интернет по&nbsp;адресу&nbsp;<a href="https://bulgakov.ru" class="modal__link" rel="noopener noreferrer" target="_blank">https://bulgakov.ru</a>.</p>
        </section>
      </div>
    </div>
  </div>
