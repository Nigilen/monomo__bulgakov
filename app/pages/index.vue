...
useSeoMeta({
  ...
  description: 'Bulgakov Prime – качественный ремонт под ключ в Калининграде. Создаем готовые пространства для жизни с дизайн-проектом в подарок. Бутиковый сервис, личная вовлеченность и безупречное качество.',
  ogTitle: 'Ремонт под ключ в Калининграде | Bulgakov Prime – Архитектура Комфорта',
  ogDescription: 'Bulgakov Prime – качественный ремонт под ключ в Калининграде. Создаем готовые пространства для жизни с дизайн-проектом в подарок. Бутиковый сервис, личная вовлеченность и безупречное качество.',
